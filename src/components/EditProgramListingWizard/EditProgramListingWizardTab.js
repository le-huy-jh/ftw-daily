...
const EditProgramListingWizardTab = props => {
  const {
    tab,
    marketplaceTabs,
    params,
  ...
  switch (tab) {
    case GENERAL: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditProgramListingWizard.saveNewGeneral'
        : 'EditProgramListingWizard.saveEditGeneral';
      return (
        <EditProgramListingGeneralPanel
          {...panelProps(GENERAL)}
    ...
    case LOCATION: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditProgramListingWizard.saveNewLocation'
    ...
    case PRICING: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditProgramListingWizard.saveNewPricing'
        : 'EditProgramListingWizard.saveEditPricing';
      return (
        <EditProgramListingPricingPanel
          {...panelProps(PRICING)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
    ...
    case AVAILABILITY: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditProgramListingWizard.saveNewAvailability'
        : 'EditProgramListingWizard.saveEditAvailability';
      return (
        <EditProgramListingAvailabilityPanel
...
EditProgramListingWizardTab.defaultProps = {
  listing: null,
  updatedTab: null,
};
...
EditProgramListingWizardTab.propTypes = {
  params: shape({
...
export default EditProgramListingWizardTab;
