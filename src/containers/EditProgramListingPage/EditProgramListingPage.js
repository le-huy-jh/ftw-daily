...
import {
  ...
  clearUpdatedTab,
  savePayoutDetails,
} from './EditProgramListingPage.duck';

import css from './EditProgramListingPage.module.css';
...
export const EditProgramListingPageComponent = props => {
  const {
    currentUser,
...
EditProgramListingPageComponent.defaultProps = {
...
EditProgramListingPageComponent.propTypes = {
...
const EditProgramListingPage = compose(
  withRouter,
  connect(
    mapStateToProps,
    mapDispatchToProps
  )
)(injectIntl(EditProgramListingPageComponent));

export default EditProgramListingPage;
